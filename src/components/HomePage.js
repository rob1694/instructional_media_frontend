        ...
        <div className = "container ">
            ...
            <div className = "row">
                    ...
                    <div className = "col">
                        ...
                        src = "https://media.istockphoto.com/photos/under-construction-concept-picture-id592021652"
                        border = '3' width = "500" height = "400"
                    />
                    </div>
            ...
            <div className = "row">
                ...
                <a className = "col" href = "http://localhost:3001/login">
